    ...
    <body>
        <div class="container">
            ...
            <div class="f00-gtc-container">
                ...
                <p class="text-danger">Boo, you didn't get any of them right. :C Better luck next time!</p>
                
                <?php } else if ( $win == 1 ) { ?>
                
                <p class="text-success">Ah, well at least you got one!</p>
                
                <?php } else if ( $win >= 2 ) { ?>
                
                <p class="text-success">Nice job, you got <?php echo $win; ?> correct!</p>
